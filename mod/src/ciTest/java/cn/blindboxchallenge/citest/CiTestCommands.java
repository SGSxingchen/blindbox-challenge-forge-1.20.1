...
public final class CiTestCommands {
    ...
    public static void register(RegisterCommandsEvent event) {
        ...
        dispatcher.register(Commands.literal("blindboxcitest")
                ...
                .then(Commands.literal("prepare_p4_text_handoff")
                        .executes(context -> P4TextCiScenario.prepareHandoff(context.getSource())))
                .then(Commands.literal("run_p4_door")
                        .executes(context -> DoorCiScenario.run(context.getSource())))
                .then(Commands.literal("start_p4_door_recovery_clients")
                        .executes(context -> P4DoorRecoveryCiScenario.start(context.getSource())))
                .then(Commands.literal("cleanup_p4_door_recovery_clients")
                        .executes(context -> P4DoorRecoveryCiScenario.cleanup(context.getSource())))
                .then(Commands.literal("run_p4_music_negative")
                        .executes(context -> MusicBoxCiAssertions.run(context.getSource())))
                .then(Commands.literal("start_p4_music_clients")
                        .executes(context -> P4MusicCiScenario.start(context.getSource())))
                .then(Commands.literal("cleanup_p4_music_clients")
                        .executes(context -> P4MusicCiScenario.cleanup(context.getSource())))
                .then(Commands.literal("start_p5_music_cache_clients")
                        .executes(context -> P5MusicCacheCiScenario.start(context.getSource())))
                .then(Commands.literal("cleanup_p5_music_cache_clients")
                        .executes(context -> P5MusicCacheCiScenario.cleanup(context.getSource())))
                .then(Commands.literal("start_p5_decor_clients")
                        .executes(context -> P5DecorCiScenario.start(context.getSource())))
                .then(Commands.literal("verify_p5_decor_clients")
                        .executes(context -> P5DecorCiScenario.verify(context.getSource())))
                .then(Commands.literal("cleanup_p5_decor_clients")
                        .executes(context -> P5DecorCiScenario.cleanup(context.getSource())))
                .then(Commands.literal("start_p5_decor_single")
                        .executes(context -> P5DecorCiScenario.startSingle(context.getSource())))
                .then(Commands.literal("verify_p5_decor_single")
                        .executes(context -> P5DecorCiScenario.verifySingle(context.getSource())))
                .then(Commands.literal("cleanup_p5_decor_single")
                        .executes(context -> P5DecorCiScenario.cleanupSingle(context.getSource())))
                ...
                .then(Commands.literal("release_p4_text_handoff")
                        .executes(context -> P4TextCiScenario.releaseHandoff(context.getSource())))
    ...
    private static int seedP4ChickenFixture(CommandSourceStack source) {
        try {
            ...
            BlockPos position = CanonicalStateExporter.p4ChickenFixturePosition(level);
