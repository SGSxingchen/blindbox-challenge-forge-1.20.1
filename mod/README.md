...
目前没有公开 Release：P5 批次 A 已替换 68 张历史 PNG，正式资源中仍有 99 项尚待权利人/法务确认，83 项尚待项目发行许可证确认。获得书面授权或完成全量可审计原创替换之前，不得创建公开 Release 或发布 Jar。详见 [资源审计清单](../docs/ASSET_MANIFEST.md)。
