# 盲盒挑战生存 Forge 模组
当前版本为 **1.0.2**，运行环境为 Java 17、Minecraft 1.20.1、Forge 47.4.22。客户端和专用服务器均只安装发布页提供的 `blindboxchallenge-1.0.2-all.jar`；下载后使用同页 SHA-256 文件执行 `sha256sum -c blindboxchallenge-1.0.2-all.jar.sha256`。
