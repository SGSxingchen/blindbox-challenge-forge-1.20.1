...
|生命周期强杀恢复|独立工作流执行 `save-all flush → SIGKILL → 同世界重启`，核验 P1/P2 持久基线；009 的 Capability 强杀恢复、真实客户端重连和能力 S2C 由双客户端专项另行核验|第一批 [31081445465](https://github.com/SGSxingchen/blindbox-challenge-forge-1.20.1/actions/runs/31081445465)、第二批 [31084532343](https://github.com/SGSxingchen/blindbox-challenge-forge-1.20.1/actions/runs/31084532343)、第三批 [31087862606](https://github.com/SGSxingchen/blindbox-challenge-forge-1.20.1/actions/runs/31087862606) 成功；009 双客户端专项仍待补|
...
|返航剪刀|真实服务端投掷实体、命中、返航、完整 NBT 与满包掉落账本|静态接入真实 `use/releaseUsing` 两次投掷、立即远距离生产扫掠/返航、背包回收、36 格满包掉落和双客户端 UUID/返航态 marker；待 Hosted Runner|
