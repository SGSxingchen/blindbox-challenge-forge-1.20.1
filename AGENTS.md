...
P1 的盲盒、打包、全局奖池、事务隔离与调试命令，以及 P2 的 50 项基础物品族均已验收归档；本仓库现进入 P3 持久能力、抱枕投掷与返航剪刀开发。P3 的范围、批次与实现记录见 [P3_IMPLEMENTATION.md](docs/P3_IMPLEMENTATION.md)，逐项门禁见 [P3_ACCEPTANCE.md](docs/P3_ACCEPTANCE.md)。原始资料在 `source-package/`，不得修改或删除；原压缩包备份在 `archive/`。
